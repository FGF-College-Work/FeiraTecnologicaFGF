...
\noindent{\textbf{INTRODUÇÃO:} O \emph{benchmark} é utilizado para verificar e comparar as melhores práticas de negócio, baseado nas metricas de desempenho e processos de negócio entre empresas, para direcionar uma estrategia de ação no planejamento, apoio, seleção e entrega de projetos. \textbf{OBJETIVO:}Este estudo apresenta uma analise abrangente sobre a adoção de tecnologias web nas principais faculdades e universidades de Fortaleza. Com o intuitio de apontar uma tendência padrão no desenvolvimento para esse nicho de mercado, permitindo um reconhecimento estrategico para validaçao de um futuro investimento.\textbf{METODOLOGIA:} A metodologia de benchmark utilizada foi o estudo do benchmark de tecnologia de informação e aplicativo. Abrangendo aspectos do processamento dos dados, analise do sistema, desenvolvimento, programação e usabilidade. O presente estudo se limita a analisar o desenvolvimento e programação, se valendo de ferramentas online de verificação de trafego e tendência tecnologica para estabelecer uma base de dados para o presente estudo.\textbf{RESULTADOS E DISCUSSÃO:} O presente estudo encontrou, baseado nos dados pesquisados, como estrutura mais usual de desenvolvimento, a adoção de soluções genéricas de gerenciamento de conteudo, customizadas de acordo com as necessidades do negócio. O uso de sistemas de gerenciamento de conteudo,  CMS (\emph{Content Management Content}), são soluções rápidas encontradas nos mais diversos segmentos de negócio. E o segmento educacional discutido nesses estudo, se mostrou presente na utilização em grande parte dos dados coletados.\textbf{CONCLUSÃO:}Podemos concluir que uso de sistemas de gerenciamento de conteúdo de código aberto, tem sido utilizado em demasiada escala pelas instituições de ensino de superior, como ferramenta de desenvolvimento padrão. \textbf{REFERÊNCIAS BIBLIOGRÁFICAS:} CASSIDY, Leonie. HAMILTON, John. \textbf{Website benchmarking: evaluating scaled and dichotomous}.2011. BOOTH, Danielle. JANSEN, Bernard. \textbf{A review of methodologies for analyzing websites}.2009. HUANG, Zhenyu. \textbf{E-government practices at local levels: an analysis of US counties’ websites}. 2006}
